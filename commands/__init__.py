...
class Command:
    ...
    async def run_async(self):
        """
        This is an async version of run(). Either run() or run_async() must
        be used. If calling run() succeeds run_async() will never be called.
        """
        raise NotImplementedError()
...
def main():
    ...
    if not hasattr(args, "command"):
        ...
        try:
            ...
            return loop.run_until_complete(args.command.run_async())
